...
{
	class AmqpGelfTransport : GelfTransportBase
	{
		...
		public override void Send(string serverHostName, IPAddress serverIpAddress, int serverPort, string message)
		{
			//Create the Connection 
			var factory = new ConnectionFactory
			{
				Protocol = Protocols.FromEnvironment(),
				HostName = serverIpAddress.ToString(),
				Port = serverPort,
